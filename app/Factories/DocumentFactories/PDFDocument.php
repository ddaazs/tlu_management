...
class PDFDocument implements DocumentProduct
{
    ...
    {
        try {
            $filePath = $data['file']->store('documents/pdf', 'public');
            ...
            return ['success' => true, 'message' => 'PDF document created successfully'];
        } catch (\Exception $e) {
            return ['success' => false, 'message' => 'Failed to create PDF document: ' . $e->getMessage()];
        }
    }
    ...
    public function update(array $data): array
    {
        try {
            ...
            return ['success' => true, 'message' => 'PDF document updated successfully'];
        } catch (\Exception $e) {
            return ['success' => false, 'message' => 'Failed to update PDF document: ' . $e->getMessage()];
        }
    }
    ...
    public function delete(): array
    {
        try {
            ...
            return ['success' => false, 'message' => 'Failed to delete PDF document: ' . $e->getMessage()];
        }
    }
    ...
    public function validate(array $data): array
    {
        $validator = Validator::make($data, [
            ...
            'file.mimes' => 'Tệp phải có định dạng PDF.',
