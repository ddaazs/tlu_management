...
<div class="d-flex">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-dark" style="width: 280px; height: 89vh; background-color: #457B9D" id="sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
              <a href="#" class="nav-link {{ request()->is('/') ? 'active' : 'text-white' }}" aria-current="page">
                  <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
                  Home
              </a>
          </li>
          <li>
              <a href="#" class="nav-link {{ request()->is('dashboard') ? 'active' : 'text-white' }}">
                  <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                  Dashboard
              </a>
          </li>
          <li>
              <a href="#" class="nav-link {{ request()->is('orders') ? 'active' : 'text-white' }}">
          ...
          <li>
              <a href="#" class="nav-link {{ request()->is('customers') ? 'active' : 'text-white' }}">
